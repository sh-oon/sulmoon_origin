  ...
  <div class="content mt-4 shadow-down relative flex flex-col gap-y-2 items-end">
    <form class="sulmoon gap-4 flex flex-col">
      ...
      <label for="phone">
        ...
        <input type="text" id="phone" inputmode="numeric" class="placeholder:text-sm" placeholder="'-'없이 입력해주세요 ex) 01012341234" v-model="param.phone">
      </label>
      <label for="email">
        ...
        <input type="text" id="email" inputmode="email" class="placeholder:text-sm" placeholder="example@gmail.com" v-model="param.email">
      </label>
    ...
    <button class="content !w-20" @click="submit">제출</button>
  </div>
</template>
